...
# ──────────────────────────────────────────────
    ...
    st.info("🔧 This module will let you enter job applications and match them against Gmail inbox to classify status as Interview, Rejected, or No Response.")

    # This is just a placeholder. We'll build full logic and UI next.
    st.markdown("✅ Coming next: Upload Excel/CSV or add manually, authenticate Gmail, classify job status using LLM or rules.")
